...
<head>
    ...
    <title>Payment Gateway - TechVista</title>
    ...
    <div class="payment-page">
        <div class="payment-container">
            ...
            <div class="payment-note">
                ...
                <ol>
                    <li>Sign up for a PayU merchant account at <a href="https://payu.in" target="_blank">payu.in</a></li>
                ...
                <p><strong>Note:</strong> This is a demo page. In production, the form will automatically submit to PayU's secure payment gateway.</p>
            </div>
            ...
            <form id="payuForm" action="<?php echo PAYU_BASE_URL; ?>" method="POST">
                ...
                <div class="payment-actions">
                    ...
                    <?php if (PAYU_MERCHANT_KEY === 'YOUR_MERCHANT_KEY'): ?>
                        <button type="button" onclick="simulatePayment()" class="btn btn-primary">Simulate Payment (Demo)</button>
                    <?php else: ?>
