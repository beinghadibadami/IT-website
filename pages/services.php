<section class="page-hero">
    <div class="container">
        ...
        <p class="page-subtitle">Comprehensive IT solutions tailored to your business needs</p>
    </div>
</section>
    ...
    <div class="container">
        <div class="services-grid">
            <div class="service-card" data-aos="fade-up">
                ...
                <p class="service-description">Custom web applications built with modern technologies. Responsive, scalable, and optimized for performance.</p>
                ...
                <button class="btn btn-primary btn-purchase" data-service="Web Development" data-price="2999">Purchase Now</button>
            </div>
            <div class="service-card" data-aos="fade-up" data-aos-delay="500">
                ...
                <p class="service-description">Transform raw data into actionable insights with advanced analytics and visualization.</p>
                <ul class="service-features">
                    ...
                    <li><i class="fas fa-check"></i> Reporting Solutions</li>
                </ul>
                <div class="service-pricing">
                    <span class="price">₹500</span>
                    <span class="price-label">Starting from</span>
                </div>
                <button class="btn btn-primary btn-purchase" data-service="Meta Ads" data-price="500">Purchase Now</button>
            </div>
            <div class="service-card" data-aos="fade-up" data-aos-delay="500">
                <div class="service-icon-wrapper">
                    <div class="service-icon">
                ...
                <button class="btn btn-primary btn-purchase" data-service="Google Ads" data-price="500">Purchase Now</button>
            </div>
            <div class="service-card featured" data-aos="fade-up" data-aos-delay="100">
                ...
                <p class="service-description">Migrate to the cloud with confidence. Scalable infrastructure, enhanced security, and reduced costs.</p>
                <ul class="service-features">
                    ...
                    <li><i class="fas fa-check"></i> Monitoring & Support</li>
                </ul>
                <div class="service-pricing">
                    <span class="price">₹4,999</span>
                    <span class="price-label">Starting from</span>
                </div>
                <button class="btn btn-primary btn-purchase" data-service="Cloud Solutions" data-price="4999">Purchase Now</button>
            </div>
            ...
            <div class="service-card" data-aos="fade-up" data-aos-delay="200">
                ...
                <p class="service-description">Harness the power of AI to automate processes, gain insights, and make data-driven decisions.</p>
                <ul class="service-features">
                ...
                <button class="btn btn-primary btn-purchase" data-service="AI & Machine Learning" data-price="7999">Purchase Now</button>
            </div>
            ...
            <div class="service-card" data-aos="fade-up" data-aos-delay="300">
                ...
                <p class="service-description">Protect your digital assets with comprehensive security solutions and threat management.</p>
                <ul class="service-features">
                ...
                <button class="btn btn-primary btn-purchase" data-service="Cybersecurity" data-price="3499">Purchase Now</button>
            </div>
            ...
            <div class="service-card" data-aos="fade-up" data-aos-delay="400">
                ...
                <button class="btn btn-primary btn-purchase" data-service="Mobile App Development" data-price="5499">Purchase Now</button>
            </div>
            ...
            <div class="service-card" data-aos="fade-up" data-aos-delay="500">
                ...
                <button class="btn btn-primary btn-purchase" data-service="Data Analytics" data-price="4299">Purchase Now</button>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="modal-content">
        ...
        <div class="payment-details">
            <div class="payment-summary">
                ...
                <p><strong>Amount:</strong> ₹<span id="selectedPrice"></span></p>
            </div>
            <form id="paymentForm" action="payment/process.php" method="POST">
                <input type="hidden" name="service" id="serviceInput">
                <input type="hidden" name="amount" id="amountInput">
                <div class="form-group" id="amountFormGroup" style="display: none;">
                    <label for="customerAmount">Amount (minimum 500)</label>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="customerPhone" name="phone" required pattern="[0-9]" maxlength="10" placeholder="Enter 10-digit phone number">
                </div>
