    ...
    <div class="container">
        <div class="footer-grid">
            ...
            <div class="footer-col">
                ...
                <ul class="footer-links">
                    <li><a href="index.php?page=services">Web Development</a></li>
                    <li><a href="index.php?page=services">Cloud Solutions</a></li>
                    <li><a href="index.php?page=services">AI & ML</a></li>
                    <li><a href="index.php?page=services">Cybersecurity</a></li>
                </ul>
            </div>
